...
export async function POST(req: NextRequest) {
  try {
    ...
    const negPrompt = `${genderNegative}, phone visible, camera visible, phone covering body, camera covering body, object blocking body, hands covering body, modesty cover, strategically covered, censored, blur censor, mosaic censor, minor, child, teen, teenager, underage, young-looking, cartoon, anime, deformed, ugly, blurry, watermark, wrong ethnicity, white person, caucasian`;
