...
async function extractFactsFromVoiceMessages(messages: ChatMessage[]) {
  ...
  const requestBody: Record<string, unknown> = {
    ...
    messages: [
      {
        role: 'system',
        content: 'From this voice call transcript, extract durable personal facts the user shared about themselves. Return ONLY a JSON array of short strings. Include preferences, boundaries, names, relationship details, how the user pronounces their name, and important personal facts. If the user explains or corrects how to say or pronounce their name, save it as "The user\'s name is pronounced ...". Do not include facts about the companion.',
      },
