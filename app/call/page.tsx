  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-black text-white p-6 md:p-24">
      <div className="z-10 w-full max-w-md items-center justify-center font-mono text-sm flex flex-col border border-gray-800 p-8 rounded-2xl bg-zinc-900/50 backdrop-blur-2xl">
        <a href="/dashboard" className="self-start text-xs text-gray-600 hover:text-white transition mb-6">← Back</a>
        ...
        <div className="w-full mb-4 text-center">
          <span className="text-xs uppercase text-gray-400 tracking-widest">Status: </span>
          <span className="text-xs uppercase text-yellow-500 tracking-widest font-bold">{status}</span>
        </div>
